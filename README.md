...
- **Key Concepts:** Persons and Organizations (Companies, Organizational Units).
- **Core Archetypes:** `Party`, `Person`, `Organization`, `PartyIdentifier`, `Address`, `PartyAuthentication`.
...
- **Core Archetypes:** `Rule`, `RuleElement`, `RuleContext`.
